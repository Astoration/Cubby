...
{
	std::string settingsIniFile = "C:/Users/Astoration/Downloads/Sidus/Resources/config/settings.ini";
...
{
	std::string optionsIniFile = "C:/Users/Astoration/Downloads/Sidus/Resources/config/options.ini";
...
void CubbySettings::SaveOptions() const
{
	...
	// Open the file
	std::string optionsIniFile = "C:/Users/Astoration/Downloads/SidusResources/config/options.ini";
